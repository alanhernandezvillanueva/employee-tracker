...
// enquirer questions to create data
async function startQuestions() {
    ...
    if (question.actions === 'View all departments') {
        viewDepartments();
...
const addEmployee = () => {
    ...
    const params = [employees[employees.length-1].newEmployeeFirstName, 
    employees[employees.length-1].newEmployeeLastName, 
    employees[employees.length-1].roleID, 
    employees[employees.length-1].managerName, 
    employees[employees.length-1].departmentID];
